...
def load_model_for_compute():
    CHECKPOINTS = "E:\\data\\modelNER\\version_7\\checkpoints\\epoch=2.ckpt"
    HPARAMS = "E:\\data\\modelNER\\version_7\\hparams.yaml"
...
def load_dataset_for_compute():
    ...
    bert_path = "E:\data\chinese_roberta_wwm_large_ext_pytorch"
    json_path = "E:\\data\\nested\\mrc-ner.evl"
    is_chinese = True
